...
class User {
  protected x = 10; // protected를 이용하여 자식 class에서 사용 가능하게 해준다(private는 불가)
}
...
class User4 {
  private static x = 10; // private: 외부에서 사용,수정하면 안되는 경우, static 자식 class에 물려주지 않음.
  public static y = 20; // public: 외부에서 수정가능(아무것도 적혀있지 않을때와 동일)
  protected z = 30; // protected: 외부에서 수정 불가, extends로 받으면 자식class 에서도 사용은 가능
}
